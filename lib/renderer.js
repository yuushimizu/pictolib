const toSVG = (component) => {
    switch (component.type) {
        case "path":
            return `<path d="${component.d}"></path>`;
        case "rect":
            return `<rect x="${String(component.x)}" y="${String(component.y)}" width="${String(component.width)}" height="${String(component.height)}"></rect>`;
        case "group":
...
export const renderAsSVG = (picto) => `<svg ${[
